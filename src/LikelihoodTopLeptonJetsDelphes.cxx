...
#include "KLFitter/LikelihoodTopLeptonJetsDelphes.h"
...
// ---------------------------------------------------------
KLFitter::LikelihoodTopLeptonJetsDelphes::LikelihoodTopLeptonJetsDelphes()
...
// ---------------------------------------------------------
KLFitter::LikelihoodTopLeptonJetsDelphes::~LikelihoodTopLeptonJetsDelphes() = default;

// ---------------------------------------------------------
int KLFitter::LikelihoodTopLeptonJetsDelphes::SetET_miss_XY_SumET(double etx, double ety, double sumet) {
...
// ---------------------------------------------------------
void KLFitter::LikelihoodTopLeptonJetsDelphes::SetLeptonType(LeptonType leptontype) {
...
// ---------------------------------------------------------
void KLFitter::LikelihoodTopLeptonJetsDelphes::SetLeptonType(int leptontype) {
...
// ---------------------------------------------------------
int KLFitter::LikelihoodTopLeptonJetsDelphes::DefineModelParticles() {
...
// ---------------------------------------------------------
void KLFitter::LikelihoodTopLeptonJetsDelphes::DefineParameters() {
...
// ---------------------------------------------------------
int KLFitter::LikelihoodTopLeptonJetsDelphes::CalculateLorentzVectors(std::vector <double> const& parameters) {
  static double scale;
...
// ---------------------------------------------------------
int KLFitter::LikelihoodTopLeptonJetsDelphes::RemoveInvariantParticlePermutations() {
  // error code
  int err = 1;
...
// ---------------------------------------------------------
int KLFitter::LikelihoodTopLeptonJetsDelphes::AdjustParameterRanges() {
  // adjust limits
...
// ---------------------------------------------------------
double KLFitter::LikelihoodTopLeptonJetsDelphes::LogLikelihood(const std::vector<double> & parameters) {
  // calculate 4-vectors
...
// ---------------------------------------------------------
std::vector<double> KLFitter::LikelihoodTopLeptonJetsDelphes::GetInitialParameters() {
...
// ---------------------------------------------------------
std::vector<double> KLFitter::LikelihoodTopLeptonJetsDelphes::GetInitialParametersWoNeutrinoPz() {
...
// ---------------------------------------------------------
std::vector<double> KLFitter::LikelihoodTopLeptonJetsDelphes::GetNeutrinoPzSolutions() {
  return CalculateNeutrinoPzSolutions();
}

// ---------------------------------------------------------
std::vector<double> KLFitter::LikelihoodTopLeptonJetsDelphes::CalculateNeutrinoPzSolutions(TLorentzVector* additionalParticle) {
...
// ---------------------------------------------------------
int KLFitter::LikelihoodTopLeptonJetsDelphes::SavePermutedParticles() {
...
// ---------------------------------------------------------
int KLFitter::LikelihoodTopLeptonJetsDelphes::SaveResolutionFunctions() {
...
// ---------------------------------------------------------
int KLFitter::LikelihoodTopLeptonJetsDelphes::BuildModelParticles() {
...
// ---------------------------------------------------------
std::vector<double> KLFitter::LikelihoodTopLeptonJetsDelphes::LogLikelihoodComponents(std::vector<double> parameters) {
