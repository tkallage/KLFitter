...
#ifndef KLFITTER_DETECTORATLASDELPHES_H_
#define KLFITTER_DETECTORATLASDELPHES_H_
...
namespace KLFitter {
/**
  * \class KLFitter::DetectorAtlasDelphes
  * \brief A class for describing the ATLAS detector in Delphes.
  *
  * This class holds the description of the ATLAS detector in Delphes.
  */
class DetectorAtlasDelphes : public DetectorBase {
 public:
  ...
  /**
    ...
    */
  explicit DetectorAtlasDelphes(std::string folder = "");

  /**
    * The (defaulted) destructor.
    */
  ~DetectorAtlasDelphes();
...
#endif  // KLFITTER_DETECTORATLASDELPHES_H_
